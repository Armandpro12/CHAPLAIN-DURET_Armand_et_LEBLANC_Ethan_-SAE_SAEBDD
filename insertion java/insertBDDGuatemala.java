...
public class insertBDDGuatemala {
    public static void main(String args[]) throws FileNotFoundException
    {
        ...
        try
        {
            ...
            String filePath = "C:/Users/ethan/Desktop/CSV/Guatemala.csv";
            ...
            int numLigne =0;
            System.out.println("insert into owid_covid_data.pays values ('GTM', 'Guatemala', 'North America', 18249868);");
            //stmt.executeUpdate("insert into owid_covid_data.pays values ('GTM', 'Guatemala', 'North America', 18249868)");
