...
public class insertBDDEthiopia {
    public static void main(String args[]) throws FileNotFoundException
    {
        ...
        try
        {
            ...
            String filePath = "C:/Users/ethan/Desktop/CSV/Ethiopia.csv";
            ...
            int numLigne =0;
            System.out.println("insert into owid_covid_data.pays values ('ETH', 'Ethiopia', 'Africa', 117876226);");
            //stmt.executeUpdate("insert into owid_covid_data.pays values ('ETH', 'Ethiopia', 'Africa', 117876226)");
