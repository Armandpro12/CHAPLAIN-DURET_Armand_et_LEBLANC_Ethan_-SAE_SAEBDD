...
public class insertBDDNorthAmerica {
    public static void main(String args[]) throws FileNotFoundException
    {
        ...
        try
        {
            ...
            String filePath = "C:/Users/ethan/Desktop/CSV/North America.csv";
            ...
            int numLigne =0;
            System.out.println("insert into owid_covid_data.pays values ('OWID_NAM', 'North America', 'North America', 596581283);");
            //stmt.executeUpdate("insert into owid_covid_data.pays values ('OWID_NAM', 'North America', 'North America', 596581283)");
