...
public class insertBDDAfrica {
    public static void main(String args[]) throws FileNotFoundException
    {
        ...
        try
        {
            ...
            String filePath = "C:/Users/ethan/Desktop/CSV/Africa.csv";
            ...
            int numLigne =0;
            System.out.println("insert into owid_covid_data.pays values ('OWID_AFR', 'Africa', 'Africa', 1373486472);");
            //stmt.executeUpdate("insert into owid_covid_data.pays values ('OWID_AFR', 'Africa', 'Africa', 1373486472)");
