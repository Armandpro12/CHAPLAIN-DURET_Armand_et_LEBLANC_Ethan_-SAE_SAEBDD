...
public class insertBDDAruba {
    public static void main(String args[]) throws FileNotFoundException
    {
        ...
        try
        {
            ...
            String filePath = "C:/Users/ethan/Desktop/CSV/Aruba.csv";
            ...
            int numLigne =0;
            System.out.println("insert into owid_covid_data.pays values ('ABW', 'Aruba', 'North America', 107195);");
            //stmt.executeUpdate("insert into owid_covid_data.pays values ('ABW', 'Aruba', 'North America', 107195)");
