...
public class insertBDDCongo {
    public static void main(String args[]) throws FileNotFoundException
    {
        ...
        try
        {
            ...
            String filePath = "C:/Users/ethan/Desktop/CSV/Congo.csv";
            ...
            int numLigne =0;
            System.out.println("insert into owid_covid_data.pays values ('COG', 'Congo', 'Africa', 5657017);");
            //stmt.executeUpdate("insert into owid_covid_data.pays values ('COG', 'Congo', 'Africa', 5657017);");
