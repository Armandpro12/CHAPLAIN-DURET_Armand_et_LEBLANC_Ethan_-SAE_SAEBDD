...
public class insertBDDGhana {
    public static void main(String args[]) throws FileNotFoundException
    {
        ...
        try
        {
            ...
            String filePath = "C:/Users/ethan/Desktop/CSV/Ghana.csv";
            ...
            int numLigne =0;
            System.out.println("insert into owid_covid_data.pays values ('GHA', 'Ghana', 'Africa', 31732128);");
            //stmt.executeUpdate("insert into owid_covid_data.pays values ('GHA', 'Ghana', 'Africa', 31732128)");
