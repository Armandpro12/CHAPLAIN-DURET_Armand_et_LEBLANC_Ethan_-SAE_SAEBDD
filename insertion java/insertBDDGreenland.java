...
public class insertBDDGreenland {
    public static void main(String args[]) throws FileNotFoundException
    {
        ...
        try
        {
            ...
            String filePath = "C:/Users/ethan/Desktop/CSV/Greenland.csv";
            ...
            int numLigne =0;
            System.out.println("insert into owid_covid_data.pays values ('GRL', 'Greenland', 'North America', 56868);");
            //stmt.executeUpdate("insert into owid_covid_data.pays values ('GRL', 'Greenland', 'North America', 56868)");
