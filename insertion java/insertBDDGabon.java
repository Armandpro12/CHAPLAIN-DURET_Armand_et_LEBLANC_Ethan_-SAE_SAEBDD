...
public class insertBDDGabon {
    public static void main(String args[]) throws FileNotFoundException
    {
        ...
        try
        {
            ...
            String filePath = "C:/Users/ethan/Desktop/CSV/Gabon.csv";
            ...
            int numLigne =0;
            System.out.println("insert into owid_covid_data.pays values ('GAB', 'Gabon', 'Africa', 2278829);");
            //stmt.executeUpdate("insert into owid_covid_data.pays values ('GAB', 'Gabon', 'Africa', 2278829)");
