...
public class insertBDDFrance {
    public static void main(String args[]) throws FileNotFoundException
    {
        ...
        try
        {
            ...
            String filePath = "C:/Users/ethan/Desktop/CSV/France.csv";
            ...
            int numLigne =0;
            System.out.println("insert into owid_covid_data.pays values ('FRA', 'France', 'Europe', 67422000);");
            //stmt.executeUpdate("insert into owid_covid_data.pays values ('FRA', 'France', 'Europe', 67422000)");
